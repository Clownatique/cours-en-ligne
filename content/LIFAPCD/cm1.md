...
_(il faut avoir finis les spécifications avant de faire la conception architecture)_
...
les reunions sont plus nombreuses
sollicitation du client plus grande
on enleve les grandes etapes du cycle en V
(Analyse des besoins, Recette, Tests de validation,Spécifications,Conception)
=> tout est immuable, pas de contrat definitif
...
- savoir placer ces fonctionnalites a implementer sur un calendrier
  !()[] #exemple ici

...
### [Interaction homme machine](lififh)
...
J'utilise Anki pour creer des flashcartes.
Pour les utiliser, deux manieres:

- Soit avec l'application officielle (vivement recommande)
- Soit avec d'autres applications types quizlet. Un avantage c le support iPhone

## Application officielles

1. Lisez [la doc.](https://docs.ankiweb.net/getting-started.html)
